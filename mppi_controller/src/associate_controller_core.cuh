...
public:
        ...
        AssociateCtrlCore(float ctrl_freq):  ctrl_freq_(ctrl_freq){
            ctrl_param_.k_p_xy << 1.2, 2.4, 0.02;
            ctrl_param_.k_p_z << 1.2, 2.7, 0.02;
            ctrl_param_.k_d_xy << 0.002, 0.003, 0.0003;
            ctrl_param_.k_d_z << 0.002, 0.004, 0.0005;
            ctrl_param_.k_i_xy << 0.15, 0.00, 0.00;
            ctrl_param_.k_i_z << 0.15, 0.00, 0.00;
            ctrl_param_.k_ff_xy = 0.1;
            ctrl_param_.k_ff_z = 0.1;
            ctrl_param_.sat_d_xy = 2.0;
            ctrl_param_.sat_d_z = 2.0;
            ctrl_param_.sat_i_xy = 8.0;
            ctrl_param_.sat_i_z = 15.0;
